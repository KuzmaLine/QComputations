...
В силу низкоуровневости MPI, некоторые решения несовсем стабильные и тяжелопереносимые, что в будущем будет исправляться. Например, переписыванием части программ на нити, использованием графических ядер или заменой на более надёжные графические интерпретаторы, чем у matplotlib Python-а.
