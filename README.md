...
В разработке версий с использованием cuda на 1 узле (Замена 2 и 3 версий)
...
1. MKL_INCLUDE_PATH - директория с заголовочными файлами Intel MKL. (Установка - sudo apt install intel-mkl)
2. PYTHON_H_INCLUDE_PATH - путь к директории, где лежит Python.h от вашего текущего интерпретатора Python 3.9 (Для 3 версии)
...
------------------------------------------------
Copyright (c) 2023 Kuzminskiy Andrey