...
Все эти библиотеки, с добавко sudo, переносятся в директорию, указанную в качестве аргумента скрипту install.sh. (То есть, если написать install.sh "/usr/lib", то 3 библиотеки перенесутся в /usr/lib)
