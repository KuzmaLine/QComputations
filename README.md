...
Разница между 2 и 3 библиотеками в том, что во 2 не реализована эффективное параллельное перемножение матриц. (Та же скорость, что и у обычного blas методом Кеннона (Не готово!))
