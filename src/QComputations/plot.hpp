...
void basis_to_file(const std::string& filename, const std::vector<std::shared_ptr<Basis_State>>& basis, std::string dir = "", ILP_TYPE main_rank = 0);
void legend_to_file(const std::string& filename, const std::vector<std::string>& str_vec, std::string dir = "", ILP_TYPE main_rank = 0);
