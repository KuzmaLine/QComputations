...
void plot_from_files(const std::string &plotname, std::string dir,
...
void make_probs_files(const Hamiltonian &H, const Probs &probs, const std::vector<double> &time_vec,
                      const BasisType<Basis_State> &basis, std::string dir = "", ILP_TYPE main_rank = 0);

void make_probs_files(const BLOCKED_Hamiltonian &H, const BLOCKED_Probs &probs, const std::vector<double> &time_vec,
                      const BasisType<Basis_State> &basis, std::string dir = "", ILP_TYPE main_rank = 0);

void make_plot(const std::string &plotname, const BLOCKED_Hamiltonian &H, const BLOCKED_Probs &probs,
               const std::vector<double> &time_vec, const BasisType<Basis_State> &basis, std::string dir);
...
void probs_to_plot(const Probs &probs, const std::vector<double> &time_vec, const BasisType<Basis_State> &basis,
                   std::vector<std::map<std::string, std::string>> keywords = {});
void probs_to_plot(const Probs &probs, const std::vector<double> &time_vec, const std::vector<std::string> &basis_str,
                   std::vector<std::map<std::string, std::string>> keywords = {});
...
void surface(const std::vector<std::vector<double>> &x, const std::vector<std::vector<double>> &y,
             const std::vector<std::vector<double>> &z, std::map<std::string, std::string> keywords = {});
#ifdef ENABLE_MPI
#ifdef ENABLE_CLUSTER
void probs_to_plot(const BLOCKED_Probs &probs, const std::vector<double> &time_vec, const BasisType<Basis_State> &basis,
                   std::vector<std::map<std::string, std::string>> keywords = {});
void probs_to_plot(const BLOCKED_Probs &probs, const std::vector<double> &time_vec,
                   const std::vector<std::string> &basis_str,
                   std::vector<std::map<std::string, std::string>> keywords = {});
void probs_in_cavity_to_plot(const BLOCKED_Probs &probs, const std::vector<double> &time_vec,
                             const BasisType<Basis_State> &basis, size_t cavity_id,
                             std::vector<std::map<std::string, std::string>> keywords = {});
#endif
#endif
void rho_probs_to_plot(const Probs &probs, const std::vector<double> &time_vec, const BasisType<Basis_State> &basis,
                       std::vector<std::map<std::string, std::string>> keywords = {});
void rho_diag_to_plot(const Probs &probs, const std::vector<double> &time_vec, const BasisType<Basis_State> &basis,
                      std::vector<std::map<std::string, std::string>> keywords = {});
void rho_subdiag_to_plot(const Probs &probs, const std::vector<double> &time_vec, const BasisType<Basis_State> &basis,
                         std::vector<std::map<std::string, std::string>> keywords = {});
void probs_in_cavity_to_plot(const Probs &probs, const std::vector<double> &time_vec,
                             const BasisType<Basis_State> &basis, size_t cavity_id,
                             std::vector<std::map<std::string, std::string>> keywords = {});
