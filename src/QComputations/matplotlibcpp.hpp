...
inline PyObject *init_3d_axis(PyObject *fig) {
    ...
    Py_INCREF(gca);
    PyObject *axis = PyObject_Call(gca, detail::_interpreter::get().s_python_empty_tuple,
...
void plot_surface(const std::vector<::std::vector<Numeric>> &x, const std::vector<::std::vector<Numeric>> &y,
    ...
    // PyObject *axis = PyObject_Call(gca,
    // detail::_interpreter::get().s_python_empty_tuple,
    // detail::_interpreter::get().s_python_empty_tuple); PyObject *axis =
    // PyObject_Call(
