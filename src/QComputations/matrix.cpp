...
template <> Matrix<double> Matrix<double>::operator*(const Matrix<double> &A) const {
    assert(m_ == A.n_);
...
template <> Matrix<int> Matrix<int>::operator*(const Matrix<int> &A) const {
...
template <> Matrix<COMPLEX> Matrix<COMPLEX>::operator*(const Matrix<COMPLEX> &A) const {
    assert(m_ == A.n_);
...
template <> Matrix<double> &Matrix<double>::operator*=(double num) {
    ILP_TYPE iONE = 1;
...
template <> Matrix<COMPLEX> &Matrix<COMPLEX>::operator*=(COMPLEX num) {
    ILP_TYPE iONE = 1;
...
template <> void Matrix<double>::write_to_csv_file(const std::string &filename) const {
...
template <> void Matrix<COMPLEX>::write_to_csv_file(const std::string &filename) const {
    std::ofstream file(filename);
